...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	riscv-none-embed-gcc -march=rv32imacxw -mabi=ilp32 -msmall-data-limit=8 -msave-restore -fmax-errors=20 -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized -g -I"c:/beifen/ESP32_P4_EV/Embedded_competition/CH32/Debug" -I"c:/beifen/ESP32_P4_EV/Embedded_competition/CH32/Core" -I"c:/beifen/ESP32_P4_EV/Embedded_competition/CH32/User" -I"c:/beifen/ESP32_P4_EV/Embedded_competition/CH32/Peripheral/inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
